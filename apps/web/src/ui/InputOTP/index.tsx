...
function InputOTPSeparator({ ...props }: React.ComponentProps<"div">) {
	return (
		<div
			...
			// biome-ignore lint/a11y/useAriaPropsForRole: <already have a role>
			role="separator"
			aria-label="OTP separator"
			{...props}
		>
			<img
				src="/assets/buttons/circle-symbol-minus.gif"
				className="h-[18px] w-[18px]"
				height={18}
				width={18}
				alt="symbol-menus-otp"
			/>
		</div>
	);
}
